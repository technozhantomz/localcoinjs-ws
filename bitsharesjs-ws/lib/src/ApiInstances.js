...
export default {
    ...
    */
    reset: function ( cs = "wss://node.commodity.llc/api", connect, connectTimeout = 4000, optionalApis, closeCb ) {
    ...
    instance: function ( cs = "wss://node.commodity.llc/api", connect, connectTimeout = 4000, optionalApis, closeCb) {
        if ( ! inst ) {
            inst = new ApisInstance();
            inst.setRpcConnectionStatusCallback(this.statusCb);
        }
